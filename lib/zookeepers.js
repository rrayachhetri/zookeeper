...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        // since our form data is coming in as string, and our JSON is storing
        // age as number, we must convert the query string to a number
...
function validateZookeepeer(zookeeper) {
